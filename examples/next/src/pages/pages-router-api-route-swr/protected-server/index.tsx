...
export default function ProtectedServer({
  ...
  return (
    <main className="p-10 space-y-5">
      <Title subtitle="Protected page" category="Checked in getServerSideProps" />
...
function Content({ session }: { session: SessionData }) {
  return (
    <div className="max-w-xl space-y-2">
      ...
      <p>getServerSideProps is used for the isLoggedIn check and to get the session data.</p>
    </div>
  );
}
