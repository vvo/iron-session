      ...
      <div className="grid grid-cols-1 gap-4 p-10 border border-slate-500 rounded-md max-w-xl">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside">
            <li>
              <Link href="/pages-router-api-route-swr/protected-client" className={css.link}>
                Protected page via client call →
              </Link>
            </li>
            <li>
              <Link href="/pages-router-api-route-swr/protected-server" className={css.link}>
                Protected page via getServerSideProps →
              </Link>{" "}
            </li>
            <li>
              <Link href="/pages-router-api-route-swr/protected-middleware" className={css.link}>
